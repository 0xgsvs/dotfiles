...
complete -c solana -n "__fish_use_subcommand" -f -a "alpenglow-genesis-info" -d 'Get info about the Alpenglow genesis cert'
...
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from alpenglow-genesis-info" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
...
complete -c solana -n "__fish_seen_subcommand_from validators" -l sort -d 'Sort order (does not affect JSON output)' -r -f -a "delinquent commission credits identity last-vote root skip-rate stake version client-id vote-account"
...
complete -c solana -n "__fish_seen_subcommand_from activate" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from revoke" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from deploy" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from extend" -l payer -d 'Payer for the additional rent [default: the default configured keypair]'
...
complete -c solana -n "__fish_seen_subcommand_from create-stake-account" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from create-stake-account-checked" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from delegate-stake" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-authorize" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-authorize-checked" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from deactivate-stake" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from split-stake" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from merge-stake" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from withdraw-stake" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup-checked" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from help" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from help" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l commission -d 'The commission taken on reward redemption (0-100). Only valid for VoteInit (v1). Cannot be used with --use-v2-instruction. [default: 100]'
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l authorized-voter -d 'Authorized voter [default: validator identity pubkey]. Address is one of:
  ...
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
  * a hardware wallet keypair URL (i.e. usb://ledger)'
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l inflation-rewards-commission-bps -d 'Commission rate in basis points (0-10000) for inflation rewards. 100 basis points = 1%. Only valid with VoteInitV2 (--use-v2-instruction or when SIMD-0464 feature is active). [default: 10000 (100%)]'
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l inflation-rewards-collector -d 'Account to collect inflation rewards commission. Only valid with VoteInitV2 (--use-v2-instruction or when SIMD-0464 feature is active). [default: vote account address] Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
  * a hardware wallet keypair URL (i.e. usb://ledger)'
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l block-revenue-commission-bps -d 'Commission rate in basis points (0-10000) for block revenue. 100 basis points = 1%. Only valid with VoteInitV2 (--use-v2-instruction or when SIMD-0464 feature is active). [default: 10000 (100%)]'
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l block-revenue-collector -d 'Account to collect block revenue commission. Only valid with VoteInitV2 (--use-v2-instruction or when SIMD-0464 feature is active). [default: identity account address] Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
...
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l use-v2-instruction -d 'Force use of VoteInitV2 (SIMD-0464). Required in sign-only mode after feature activation. In normal mode, instruction version is auto-detected based on feature status.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter-checked" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter-checked" -l use-v2-instruction -d 'Force BLS key derivation (SIMD-0387). Required in sign-only mode after feature activation. In normal mode, BLS usage is auto-detected based on feature status.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer-checked" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-update-validator" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-update-commission" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-vote-account" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from close-vote-account" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from transfer" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword or the pubkey of an offline signer, provided an appropriate --signer argument is also passed. Defaults to the client keypair.'
